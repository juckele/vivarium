...
public class SpriteRenderer
{
    ...
    public void draw(Sprite sprite, int r, int c, Direction d)
    {
        ...
        // Render the sprite
        _context.drawImage(_imageElement, sourceX, sourceY, PIXEL_BLOCK_SIZE, PIXEL_BLOCK_SIZE, -0.5 * PIXEL_BLOCK_SIZE,
                -0.5 * PIXEL_BLOCK_SIZE, PIXEL_BLOCK_SIZE, PIXEL_BLOCK_SIZE);
