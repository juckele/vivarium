...
public class GeneratePopulationSummaryCSV extends Script
{
    ...
    protected void run(String[] args)
    {
        ...
        StringBuilder csvStringBuilder = new StringBuilder(
                "unique_population,min_population,max_population,mean_population,population_stddev\n");
        ...
        // Iterate through and count total population ticks and look for min/max
        // values
